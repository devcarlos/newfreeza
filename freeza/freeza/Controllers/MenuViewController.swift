...
class MenuViewController: UIViewController {
    ...
    var menus: Array = [
        ["txtMenu": "Home", "imgMenu": "home"],
        ["txtMenu": "SiteMap", "imgMenu": "sitemap"],
        ["txtMenu": "Google Search", "imgMenu": "google"],
        ["txtMenu": "About Us", "imgMenu": "about"]
    ]
...
extension MenuViewController: UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.setData(self.menus[indexPath.row] as [String: AnyObject])
        return cell
    }
}
...
extension MenuViewController: UITableViewDelegate {
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        self.delegate?.menuHandler(index: indexPath.row + 1)
    }
}
